...
static ConfigEntry<bool> shaderCachePreloadEnabled(false);
...
bool getShaderCachePreloadEnabled() {
    return shaderCachePreloadEnabled.get();
}
...
void setShaderCachePreloadEnabled(bool enable, bool is_game_specific) {
    shaderCachePreloadEnabled.set(enable, is_game_specific);
}
...
void load(const std::filesystem::path& path, bool is_game_specific) {
    ...
    if (data.contains("GPU")) {
        ...
        shaderCachePreloadEnabled.setFromToml(gpu, "shaderCachePreload", is_game_specific);
...
void save(const std::filesystem::path& path, bool is_game_specific) {
    ...
    shaderCachePreloadEnabled.setTomlValue(data, "GPU", "shaderCachePreload", is_game_specific);
...
void setDefaultValues(bool is_game_specific) {
    ...
    shaderCachePreloadEnabled.set(false, is_game_specific);
